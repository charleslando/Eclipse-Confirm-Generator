...
//                             <div onChange={e => setParsedTrade({ ...parsedTrade, isLive: e.target.value === 'Live' })}>
//                                 <label><input type="radio" name="tradeType" value="Live" checked={parsedTrade.isLive}/> Live</label>
//                                 <label><input type="radio" name="tradeType" value="Hedged" checked={!parsedTrade.isLive}/> Hedged</label>
//                             </div>
//                             {/*<div>< className="w-full p-1 border rounded" value={parsedTrade.isLive} onChange={event => e.value}></></div>*/}
...
//                             <div><label>Underlying</label><input type="number" className="w-full p-1 border rounded" value={parsedTrade.underlying} onChange={e => setParsedTrade({ ...parsedTrade, underlying: parseInt(e.target.value,10)||0 })} /></div>
//                             <div><label>Cleared</label><select className="w-full p-1 border rounded" value={cleared} onChange={event => setCleared(event.target.value)}>{['CME', 'ICE'].map(s => <option key={s}>{s}</option>)}</select></div>
//
//                         </div>
//                     </div>
